...
import login from '../../assets/121421-login.json';

const Login = () => {
    return (
        <div className="bg-[url('https://i.ibb.co/RYcKxq5/27580.jpg')] py-5 flex justify-center items-center">
            <div className='w-1/2 mx-auto hidden lg:block'>
                <Lottie animationData={login} loop={true} />
            </div>
            <div className="w-11/12 lg:w-1/3 my-5 mx-auto bg-white text-black p-4 rounded-md lg:pr-10 py-10">
                <form>
